...
```{r, warning=FALSE}
model_conditional_mean_value <- function(data, selected_variables, mean_method = "linear", poly_mean_degree = NULL, specific_x = NULL) {
...
```{r, warning=FALSE}
model_conditional_quantile_fun <- function(data, selected_variables, quantile_method = "linear", poly_quant_degree = NULL, quantiles = 0.5) {
  if (length(selected_variables) != 2) {
    return(NULL)
  }
