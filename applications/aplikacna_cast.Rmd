...
```{r}
result <- combine_conditional_models(data, c("carb", "mpg"), "poly", "poly", 3, 3, c(0.05, 0.95))
...
```{r, warning=FALSE}
printVariables(data)
model_joint_distribution_density(data = mtcars, selected_variables = c("carb", "mpg"), model_type = "t")
```
