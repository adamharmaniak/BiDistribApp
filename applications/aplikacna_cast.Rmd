...
mixture_joint_distribution <- function(data, discrete_vars, continuous_vars, model_type, bw) {
  ...
  if (model_type == "normal") {
    ...
    message("Kontrola normovania zmesi hustoty: Celkový integrál = ", round(total_integral, 4))
...
```{r, warning=FALSE}
printVariables(data)
model_joint_distribution_density(data = mtcars, selected_variables = c("carb", "mpg"), model_type = "normal")
```
