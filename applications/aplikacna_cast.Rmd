...
model_joint_distribution_density(data = mtcars, selected_variables = c("hp", "mpg"), model_type = "parametric", bw = NULL, use_copula = TRUE, copula_type = "Frank", marginal_densities = c("dnorm", "log_dnorm"))
```
...
```{r}
printVariables(mtcars)
plot_conditional_densities(data = mtcars, selected_variables = c("mpg", "hp"), n_breaks = 5, density_scaling = 50, ordinal = TRUE, mean_curve = FALSE, quantiles = NULL, mean_poly_degree = 2, quantile_poly_degree = 3, normal_density = FALSE, empirical_density = TRUE, bw_scale = 0.05)
```
