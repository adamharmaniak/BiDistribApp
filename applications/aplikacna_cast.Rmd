...
```{r, warning=FALSE}
model_conditional_mean_value <- function(data, selected_variables, quantiles = 0.5, specific_x = NULL, mean_method = "linear", poly_degree = NULL) {
...
```{r, warning=FALSE}
result <- model_conditional_mean_value(data, c("mpg", "disp"), c(0.1, 0.9), 100, "poly", 2)
...
- moznosti su:
  ...
  b) Parametricke modely
    ...
    2. **"poly"** (polynomialny regresny model, zadava sa aj s parametrom poly_degree = 1,2,3,..., pre *poly_degree = 1* dava          *"linear"*)
