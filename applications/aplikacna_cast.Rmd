...
```{r}
plot_conditional_densities <- function(data, selected_variables, mean_curve = TRUE, quantiles = NULL, mean_poly_degree = 1, quantile_poly_degree = 1, n_breaks = 5, density_scaling = 2000, normal_density = TRUE, empirical_density = TRUE) {
...
```{r}
printVariables(iris)
plot_conditional_densities(data = iris, selected_variables = c("Sepal.Length", "Petal.Length"), mean_curve = TRUE, quantiles = c(0.1, 0.9), mean_poly_degree = 1, quantile_poly_degree = 2, n_breaks = 4, density_scaling = 1, normal_density = TRUE, empirical_density = TRUE)
```
...
Riesim:
  - modelovanie podmienenej pravdepodobnostnej funkcie (v pripade diskretnej premennej ako odozvy)
