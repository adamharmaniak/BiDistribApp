...
```{r, warning=FALSE}
model_conditional_mean_value <- function(data, selected_variables, mean_method = "linear", poly_degree = NULL, quantiles = 0.5, specific_x = NULL) {
...
```{r, warning=FALSE}
result <- model_conditional_mean_value(data, c("mpg", "disp"), "poly", 3)
...
```{r, warning=FALSE}
printVariables(data)
model_joint_distribution_density(data, c("mpg", "disp"), "kernel")
```
