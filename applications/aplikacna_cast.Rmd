...
```{r, warning=FALSE}
result <- model_conditional_mean_value(data, c("mpg", "hp"), "poly", "poly", 2, 3, c(0.05, 0.95), 150)
...
```{r, warning=FALSE}
printVariables(data)
model_joint_distribution_density(data, c("mpg", "disp"), "kernel", TRUE, "empirical", 0.2)
```
