...
plot_classification_ridge_1D <- function(data, response_name, predictor_name, model, method) {
  ...
  if (method == "logistic") {
    ...
    data$pred_class <- factor(pred, levels = levels(data[[response_name]]))
...
model_joint_distribution_density(data = mtcars, selected_variables = c("carb", "cyl"), model_type = NULL, bw = NULL, use_copula = FALSE, copula_type = NULL, marginal_density = NULL)
```
