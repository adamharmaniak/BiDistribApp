...
# Modelovanie podmienenej strednej hodnoty a kvantilových funkcie (regresia)
...
```{r, warning=FALSE}
result <- combine_conditional_models(data, c("carb", "hp"), "poly", "poly", 2, 3, c(0.05, 0.95), 150)
...
- model_conditional_mean_value:
  a) osetrit formatovanie diskretnej premennej ako odozvy (v pripade ze by bolo nespravne. Neciselne hodnoty apod.)
  b) rozdelit funkciu na dve (pre strednu hodnotu a pre kvantily)
