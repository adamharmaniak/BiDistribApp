...
model_joint_distribution <- function(data, variables) {
  ...
  # Vsetky premenne diskretne a pocet je 2 => tabulka pravdepodobnosti a 3D vizualizacia
...
result <- model_joint_distribution(mtcars, variables)

#if (inherits(result, "plotly")) {
#  result
#} else if (inherits(result, "gg")) {
#  print(result)
#} else {
#  print(result)
#}
