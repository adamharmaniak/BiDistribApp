...
\begin{itemize}
  \item \textit{Medián} ($q = 0{,}5$): rozdeľuje rozdelenie na dve rovnaké časti,
  \item \textit{Kvartily} ($q = 0{,}25$, $0{,}5$, $0{,}75$): rozdeľujú rozdelenie na štyri rovnaké časti,
  \item \textit{Percentily} ($q = \frac{p}{100}$, $p = 1, 2, \dots, 99$): rozdeľujú rozdelenie na 100 rovnakých častí.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textit{Všeobecná polynomiálna regresia n-tého stupňa}
...
Ak pozorujeme $n$ realizácií premenných, môžeme model zapísať v maticovej forme ako:
\begin{equation}
...
kde $f_{kj}(x_j)$ je podmienená hustota (alebo pravdepodobnosť) pre $X_j$ vzhľadom na triedu $Y = c_k$.
